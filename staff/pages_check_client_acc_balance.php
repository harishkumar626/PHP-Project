                                    ...
                                    <div class="row">
                                        <div class="col-12 table-responsive">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>₹ <?php echo number_format($deposit, 2); ?></td> <!-- Updated to display ₹ -->
                                                        <td>₹ <?php echo number_format($withdrawal, 2); ?></td> <!-- Updated to display ₹ -->
                                                        <td>₹ <?php echo number_format($Transfer, 2); ?></td> <!-- Updated to display ₹ -->
                                                        <td>₹ <?php echo number_format($money_in, 2); ?></td> <!-- Updated to display ₹ -->
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <th>Funds Out</th>
                                                        <td>₹ <?php echo number_format($money_out, 2); ?></td> <!-- Updated to display ₹ -->
                                                    </tr>
                                                    <tr>
                                                        <th>Sub Total:</th>
                                                        <td>₹ <?php echo number_format($money_in, 2); ?></td> <!-- Updated to display ₹ -->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>₹ <?php echo number_format($rate_amt, 2); ?></td> <!-- Updated to display ₹ -->
                                                    </tr>
                                                    <tr>
                                                        <th>Total Balance:</th>
                                                        <td>₹ <?php echo number_format($totalMoney, 2); ?></td> <!-- Updated to display ₹ -->
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
