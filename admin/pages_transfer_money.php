                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="receiving_acc_no" required class="form-control" id="receiving_acc_no" placeholder="Enter Receiving Account Number">
                                                </div>
                                                
                                                <div class="col-md-4 form-group">
                                                    <label for="receiving_acc_holder">Receiving Account Holder</label>
                                                    <input type="text" name="receiving_acc_holder" required class="form-control" id="receiving_acc_holder" placeholder="Enter Receiving Account Holder">
                                                </div>
                                            </div>
